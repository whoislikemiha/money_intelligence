                        ...
                        <div className="flex justify-between items-center ">
                            ...
                            <div className="flex items-center gap-2">
                                <div className="bg-card border rounded-lg flex-shrink-0 overflow-hidden">
                                    <div className="flex">
                                        <div
                                            className={`p-6 cursor-pointer transition-all hover:bg-accent ${
                                                balanceViewType === 'all' ? 'bg-accent ring-2 ring-primary' : ''
                                            }`}
                                            onClick={() => {
                                        ...
                                        <div
                                            className={`p-6 cursor-pointer transition-all hover:bg-accent ${
                                                balanceViewType === 'income' ? 'bg-accent ring-2 ring-primary' : ''
                                            }`}
                                            onClick={() => {
                                    ...
                                    <div
                                        className={`p-6 cursor-pointer transition-all hover:bg-accent ${
                                            balanceViewType === 'expense' ? 'bg-accent ring-2 ring-primary' : ''
                                        }`}
                                        onClick={() => {
